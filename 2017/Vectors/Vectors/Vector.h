...
struct Vector : Vector< VecType, 4 >
{
  ...
  public:
     ...
     */
    explicit Vector( const VecType &Initializer ) noexcept;
     ...
     */
    explicit Vector( const VecType *Items ) noexcept; 
    explicit Vector( std::initializer_list< VecType > &&Items ) noexcept;

    Vector( const Vector< VecType, VecSize > &Copy ) noexcept;
    Vector( Vector< VecType, VecSize > &&Move ) noexcept;
  
    template< typename OtherType >
    explicit Vector( const Vector< OtherType, VecSize > &Copy ) noexcept;

    template< typename OtherType >
    explicit Vector( Vector< OtherType, VecSize > &&Move ) noexcept;
  
  public:
    VecType & operator[]( size_t Index ) ExceptDebug;
    const VecType & operator[]( size_t Index ) const ExceptDebug;
    ...
    const Vector< VecType, VecSize > operator+( const Vector< VecType, VecSize > &Rhs ) const noexcept;
    const Vector< VecType, VecSize > operator+( const VecType &Rhs ) const noexcept;
    ...
    operator Vector< NewType, VecSize >() const noexcept;
...
struct Vector< VecType, 4 > : Vector< VecType, 3 >
{
  ...
  public:
    ...
    Vector( const Vector< VecType, 4 > &Copy ) noexcept;
    Vector( Vector< VecType, 4 > &&Move ) noexcept;

    template< typename OtherType >
    explicit Vector( const Vector< OtherType, 4 > &Copy ) noexcept;

    template< typename OtherType >
    explicit Vector( Vector< OtherType, 4 > &&Move ) noexcept;
  ...
  public:
    ...
    const Vector< VecType, 4 > operator+( const Vector< VecType, 4 > &Rhs ) const noexcept;
    const Vector< VecType, 4 > operator+( const VecType &Rhs ) const noexcept;
    ...
    template< typename NewType >
    operator Vector< NewType, 4 >() const noexcept;
...
struct Vector< VecType, 3 > : Vector< VecType, 2 >
{
  ...
  public:
    ...
    Vector( const Vector< VecType, 3 > &Copy ) noexcept;
    Vector( Vector< VecType, 3 > &&Move ) noexcept;

    template< typename OtherType >
    explicit Vector( const Vector< OtherType, 3 > &Copy ) noexcept;

    template< typename OtherType >
    explicit Vector( Vector< OtherType, 3 > &&Move ) noexcept;
    ...
    const Vector< VecType, 3 > operator+( const Vector< VecType, 3 > &Rhs ) const noexcept;
    const Vector< VecType, 3 > operator+( const VecType &Rhs ) const noexcept;
    ...
    template< typename NewType >
    operator Vector< NewType, 3 >() const noexcept;
...
struct Vector< VecType, 2 >
{
  ...
  public:
    ...
    Vector( const Vector< VecType, 2 > &Copy ) noexcept;
    Vector( Vector< VecType, 2 > &&Move ) noexcept;

    template< typename OtherType >
    explicit Vector( const Vector< OtherType, 2 > &Copy ) noexcept;

    template< typename OtherType >
    explicit Vector( Vector< OtherType, 2 > &&Move ) noexcept;
  ...
  public:
    ...
    const Vector< VecType, 2 > operator+( const Vector< VecType, 2 > &Rhs ) const noexcept;
    const Vector< VecType, 2 > operator+( const VecType &Rhs ) const noexcept;
    ...
    template< typename NewType >
    operator Vector< NewType, 2 >() const noexcept;
 ...
 * Can't be used to create Vectors.  Must create them manualy: Vector< int, 3 > ConstIntVec{ 1, 2, 3 };
 */
template< typename Type, size_t Size >
auto MakeVector( Type( &&Items )[ Size ] ) noexcept;
