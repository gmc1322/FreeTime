...
class ConversationTree
{
  public:
    ...
    {
      public:
        typedef std::vector< Triple< int, std::string, ConversationTreeSpace::TreeText > > ResponseType;
  ...
  private:
    const ConversationTreeSpace::TreeText Head;
    mutable const ConversationTreeSpace::TreeText *CurrentText = &Head; //!< Make this mutable since the text can never change, just the ptr to it.
};
