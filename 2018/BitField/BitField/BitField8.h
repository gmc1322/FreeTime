...
class BitField< uchar_BitCount >
{
  ...
  public:
    static constexpr uchar BitCount = uchar_BitCount;
  ...
  public:
    ...
    template< MaxBits Count >
    const BitField< uchar_BitCount + Count > operator+( const BitField< Count > &Rhs  ) const noexcept;
    template< MaxBits Count >
    const BitField< uchar_BitCount + Count > operator+(       BitField< Count > &&Rhs ) const noexcept;
