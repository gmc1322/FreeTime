...
std::string & operator<<( std::string &String, ConversationTreeWindow_Base::WindowTypes WindowType) noexcept
{
  switch( WindowType )
  {
    case ConversationTreeWindow_Base::Player:
      String << "P";
      break;

    case ConversationTreeWindow_Base::NPC: 
      String << "N";
      break;
